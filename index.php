<?php
// Página principal - Listagem de Certificados
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
...
<body>
    ...
    <nav>
        <a href="front/cadastro-certificado.php">📝 Cadastrar Certificado</a>
        <a href="front/atividades.php">📚 Cadastrar Atividades</a>
